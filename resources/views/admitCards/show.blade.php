...
<html lang="en">
  ...
  <body>
    <table style="margin-bottom:-6px"  class="main-table mx-auto">
          ...
          <table class="table table-sm table-borderless border">
            <tr>
              ...
              <td style="p-0" rowspan="5" width="150">
                <img class="border border-dark" width="100%" src="https://anshumemorial.in/v2/public/uploads/images/students/Kunal_20220405-124010.jpg">
              </td>
            </tr>
            <tr>
              <th>Father's Name</th>
      ...
      <tr>
      <!-- marks -->
        <td class="py-0 align-baseline"  style="height:470px;border: 1px solid black;">
          <table class="table table-sm table-bordered w-100">
            <tr>
              <td>
                <table class="table table-bordered marks text-center border mb-0">
                  <thead>
                    <tr>
                  ...
                  <tr>
                    ...
                    <th>{{ $result->total }}</th>
                    <th>{{ $result->marks->science_oral + $result->marks->sst_oral }}</th>
                    <th>{{ $result->total + $result->marks->science_oral + $result->marks->sst_oral }}</th>
                    <th>A</th>
                  </tr>
                  <tr>
                    <td colspan="5" class="text-start ps-5">
                      <strong>Obtained Marks in words:</strong> Two hundred fourty four
                    </td>
                  </tr>
                  <tr class="bg-dark text-light border border-dark">
                    <td colspan="6"  class="text-start">Drawing</td>
                  </tr>
              ...
              <td width="200" class="p-3">
                <table width="100%" >
                  <tr>
                    <td colspan="3">
                      {!! QrCode::size(180,180)->generate("
                      Name: $stu->name, Father's Name: $stu->father, Mother: $stu->mother, 
                      Session: $result->_session, Class: $stu->class, 
                      Roll: $stu->roll, json_encode($result->marks)
                      "); !!}
                      <img class="border border-dark" height="180" width="180" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRt-R13-yFlTpvfDRQPqRTfuPiFT7-Z131sA&usqp=CAU">
                    </td>
                  </tr>
                  <tr>
      ...
      <tr>
        <!-- office section -->
        <td class="align-bottom"  style="height:185px;border: 1px solid black;">
