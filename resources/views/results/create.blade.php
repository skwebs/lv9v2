        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="row"  method="POST" action="{{ route('result.store', ['class'=>$stu->class,'roll'=>$stu->roll, 'session'=>'2021-22','redirect_to'=>url()->previous()]) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3 col-4 col-md-3">
                            <label for="science"
                                ...
                                <input id="science" type="number" class="form-control @error('science') is-invalid @enderror"
                                    ...
                                    value="{{ old('science') }}" name="science" required>
...
<div class="mb-3 col-4 col-md-3">
    <label for="science_oral" class="form-label">{{ __('Sc. Oral') }}{!! $mandate !!}</label>
        ...
        <input id="science_oral" type="number" class="form-control @error('science_oral') is-invalid @enderror"
            ...
            value="{{ old('science_oral') }}" name="science_oral" pattern="^[0-9]{2}$" required >
                        ...
                        <div class="mb-3 col-4 col-md-3">
                            <label for="sst"
                                ...
                                <input id="sst" type="number" class="form-control @error('sst') is-invalid @enderror"
                                    ...
                                    value="{{ old('sst') }}" name="sst" required>
...
<!-- //sst_oral -->
      ...
      name="drawing" value="{{ old('drawing') }}" autocomplete="bday" required>
...
<div class="mb-3 col-4 col-md-3">
    <label for="full_marks"
        ...
        <input id="full_marks" type="number" class="form-control @error('full_marks') is-invalid @enderror"
            ...
            name="full_marks" value="{{ old('full_marks') }}" required readonly>
