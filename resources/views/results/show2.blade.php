...
<body>
   ...
   <div class="marksheet mx-auto">
      ...
      <table width="735" >
         <tbody>
            ...
            <tr>
               <td>
                  <table class="table table-sm mx-auto border-0" style="width: 100%">
                     <!-- student details row -->
                     <tr>
                        ...
                        <td style="width: 20%">
                           <table style="width: 100%" class="table">
                              ...
                              <tr>
	                              <th class="nowrap" >Marks %</th>
	                              <td><strong>:</strong></td>
	                              <td class="nowrap" >{{ round(($result->total * 100)/$result->full_marks, 2) }} %</td>
                              </tr>
            ...
            <tr>
               <td>
                  <table class="table table-sm table-striped mx-auto marks" style="width: 80%">
                     ...
                     <tr>
                        ...
                        <td>100</td>
                     <td>{{ $result->marks->drawing }}</td>
                     <td>{{ res($result->marks->drawing)["g"] }}</td>
                     </tr>
                     <tr>
                  ...
                  <p class="px-5"><strong>Marks in word : </strong>{{ $result->total_text }}</p>
   ...
   <p style="width:735px" class="d-flex justify-content-center  text-center text-muted nowrap">
      <span>Designed & Developed by
      <a class="d-inline-block"  href="http://twitter.com/AnshuMemorial" target="_blank">Anshu Memorial Academy</a>
      (IT Team).</span>
   </p>
